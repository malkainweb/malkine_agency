  ...
  return (
    <>
      <nav className="w-full   h-[10vw] fixed  z-[99] top-0 left-0  flex  p_r  items-center justify-between bg-transparent">
        ...
        {/* menu icons */}
        <div
          className="w-[3.8vw] p-[1vw] flex justify-center items-center h-[3.8vw]  rounded-[100%] bg-[#CED7D7] bg-opacity-[37%]  cursor-pointer hover:bg-[#c7c5c5] backdrop-blur-[25px]"
          onClick={() => {
            setleft("0");
            setright("0");
            setopacity(1);
