...
const Before_client_logo = () => {
  return (
    <div className="w-full bg-white py-[30px] p_r">
      <div className="w-full h-[500px] rounded-[40px] before_client_logo flex flex-col justify-end py-[50px] px-[40px]">
        <div className=" flex flex-col gap-[20px] text-white ">
          ...
          <h1 className="nova text-[40px] font-medium">
            We are malkain, we design, we build, we <br />
            create perfection
          </h1>
          <button className="nova w-fit  text-[16px] font[900]text-white rounded-[39px] px-[50px] py-[16px] bg-[white] text-[#D01717] hover:bg-[#cecdcd]">
