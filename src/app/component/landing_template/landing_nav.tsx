  ...
  return (
    <>
      ...
      <div
        ...
        className={` fixed sm:top-[10vw] top-[1.8vw] translate-x-[-50%]  sm:flex left-[50%] z-[1000] sm:rounded-[2.5vw] sm:w-[15vw] w-[4.5vw] h-[4.5vw] sm:h-[15vw] sm:p-[1.5vw] p-[0.5vw] rounded-[0.6vw] bg-white bg-opacity-[19%] backdrop-blur-xl  justify-center items-center`}
      >
