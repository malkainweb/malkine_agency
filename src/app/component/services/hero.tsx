    ...
    <>
      <div className="w-full py-[0.8vw] px-[0.8vw] h-[120vw] ">
        <div className="w-full flex flex-col rounded-[3.3vw] gap-[10vw] h-full  hero_bg">
          ...
          <div className="w-full flex flex-col gap-[1.7vw] pt-[12vw]   blend px-[5.13vw]">
            <p className="nova  text-[1.6vw] font-[900]  text-[#dcdcdc] ">
              Services
            </p>
            <h1
              className="novabold  text-[2.7vw] text-[#232323] "
            ...
            <button className="nova w-fit  text-[1.07vw] font[900]text-white rounded-[2.6vw] px-[3.3vw] py-[1.07vw] bg-[#D01717] text-white hover:bg-[#920808]">
