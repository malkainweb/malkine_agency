...
const Portfolio = () => {
  return (
    <>
      <div className="w-full  px-[3.3vw] sm:px-[3.75vw] h-auto py-[5.3vw] flex flex-col gap-[1.3vw]">
        ...
        <div className="flex  justify-between  sm:gap-[4.5vw] flex-wrap w-full h-auto">
          ...
          <Link
            href="#"
            className="w-[24.6%] sm:block h sm:py-[4vw]idden  port_wrap sm:h-[62.25vw] sm:w-[44vw] rounded-[10px]  cursor-pointer py-[2vw] h-[23.3vw] px-[2vw]"
          >
            <div className="flex flex-col justify-between h-full">
              <div className="sm:gap-[1.25vw] sm:pt-[5vw] flex flex-col gap-[10px] capitalize">
