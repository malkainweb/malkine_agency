    ...
    <div className="bg-gray-100 min-h-screen pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <p className="mb-4">
          ...
          privacy policy linked on the footer on malkain.com
        </p>
        ...
        <p className="mb-4">
          You agree to indemnify, defend and hold harmless Malkain and our
        ...
        <p>
          Our contact information is posted below: Malkain Designs LLC
          Support@malkain.com 317 George St, 3rd FL New Brunswick, NJ, 08901
        </p>
      </div>
    </div>
  );
