  ...
  return (
    <>
      <div className="w-full h-auto p_r py-[100px]">
        <div className="w-full h-auto flex gap-[20px] relative">
          <div className="w-auto  nova ">
            <p className="inter text-[24px] text-white text-opacity-[50%]">
              Works
            </p>
            <h1 className="text-[50px] text-white">Our Top Works</h1>
          </div>
          <Image src={main} alt="our works logo" className="w-full h-fit " />
        </div>
      </div>
    </>
  );
