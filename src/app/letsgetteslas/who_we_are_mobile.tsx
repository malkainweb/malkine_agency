    ...
    <>
      <div className="w-full  hidden justify-between sm:py-[7vw]  sm:flex flex-col relative   ">
        ...
        <div className=" h-[48vw]  w-full relative sm:overflow-scroll hide_scroll_bar ">
          <div className="absolute top-0 flex px-[2vw] sm:gap-[3vw] h-[46vw] left-0 w-auto ">
            {items.map((e: any, index: any) => {
              return (
                <div
                  ...
                  } justify-center text-white  w-[72vw]   backdrop-blur-3xl rounded-[3.2vw] h-full`}
                >
                  <h2 className={`text-[12vw]`}>{e.heading}</h2>
                  <h2 className={`text-[5vw] pr-[10vw] leading-[7vw]`}>
                    {e.body}
                  </h2>
                </div>
              );
